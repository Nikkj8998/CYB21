...
const TermsOfService = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0a0f1c]">
      <Helmet>
        <title>Terms of Service – Cybaem Tech Private Limited</title>
        <meta
          name="description"
          content="Terms of Service for Cybaem Tech Private Limited. Understand the terms and conditions governing our IT services."
        />
        <link rel="canonical" href="https://www.cybaemtech.com/terms-of-service" />
      </Helmet>
          ...
          <main className="flex-1 space-y-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-white font-semibold text-lg mb-2">Welcome to Cybaem Tech Private Limited</h2>
            ...
            {/* Section 1 */}
            <div id="services" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
            ...
            {/* Section 2 */}
            <div id="service-agreement" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-white text-xl font-semibold">Service Agreement</h2>
              </div>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* Section 3 */}
            <div id="payments" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
            ...
            {/* Section 4 */}
            <div id="delivery" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-8 rounded-full bg-blue-500/20 text-blue-400 font-bold text-sm flex items-center justify-center">4</span>
                <h2 className="text-white text-xl font-semibold">Delivery</h2>
              </div>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* Section 5 */}
            <div id="intellectual-property" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-white text-xl font-semibold">Intellectual Property</h2>
              </div>
              <p className="text-gray-400 leading-relaxed">
            ...
            {/* Section 6 */}
            <div id="limitation" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
            ...
            {/* Section 7 */}
            <div id="modifications" className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-8 rounded-full bg-blue-500/20 text-blue-400 font-bold text-sm flex items-center justify-center">7</span>
                <h2 className="text-white text-xl font-semibold">Modifications</h2>
              </div>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div id="contact" className="bg-white/5 border border-blue-500/30 rounded-2xl p-8 backdrop-blur-sm scroll-mt-28">
              <div className="flex items-center gap-3 mb-4">
                <span className="w-8 h-8 rounded-full bg-blue-500/20 text-blue-400 font-bold text-sm flex items-center justify-center">8</span>
                <h2 className="text-white text-xl font-semibold">Contact Information</h2>
              </div>
              <div className="space-y-3">
                <p className="text-white font-medium">Cybaem Tech Private Limited</p>
                ...
                <div className="flex items-center gap-3 text-gray-400">
                  ...
                  <a href="https://cybaemtech.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">https://cybaemtech.com</a>
                </div>
              </div>
            </div>
